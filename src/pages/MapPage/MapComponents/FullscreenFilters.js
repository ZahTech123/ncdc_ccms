...
const FullscreenFilters = ({
  ...
  // Single handler for manual zoom out button
  ...
  return (
    <div className="absolute top-0 right-0 mt-16 mr-4 w-80 bg-white shadow-lg rounded-lg z-20 p-6 animate-slide-in border border-gray-300">
